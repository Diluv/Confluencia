...
VALUES ('Bookshelf', 'bookshelf', 'An open source library for other mods!', 'An open source library for other mods!', 0,
        FALSE, TRUE, FROM_UNIXTIME(1426128779), FROM_UNIXTIME(1583375717), 1, 'minecraft-je', 'mods'),
       ...
       ('Splashy', 'splashy', 'Allows greater control over the splash text on the main menu.',
        'Allows greater control over the splash text on the main menu.', 0, FALSE, TRUE, FROM_UNIXTIME(1576326746),
        FROM_UNIXTIME(1583107620), 1,
        'minecraft-je', 'mods'),
       ('Modded Bingo', 'modded-bingo', 'Adds a bingo like scavenger hunt minigame to your modded world.',
        'Adds a bingo like scavenger hunt minigame to your modded world.', 0, FALSE, TRUE, FROM_UNIXTIME(1558066682),
       ...
       ('Enchantment Descriptions', 'enchantment-descriptions',
        ...
        FROM_UNIXTIME(1472450423),
        FROM_UNIXTIME(1583225636), 1,
        'minecraft-je', 'mods'),
       ('Eerie Entities', 'eerie-entities', 'Adds new mobs that fit the minecraft atmosphere.',
        'Adds new mobs that fit the minecraft atmosphere.', 0, FALSE, TRUE, FROM_UNIXTIME(1539544785),
        FROM_UNIXTIME(1580546708), 1, 'minecraft-je', 'mods'),
       ('OldJavaWarning', 'oldjavawarning', 'Warns users when java is outdated.', 'Warns users when java is outdated.',
        0, FALSE, TRUE, FROM_UNIXTIME(1525740110), FROM_UNIXTIME(1579932587), 1, 'minecraft-je', 'mods'),
       ('Wawla - What Are We Looking At', 'wawla-what-are-we-looking-at',
        ...
        FROM_UNIXTIME(1580940550), 1, 'minecraft-je', 'mods'),
       ('Dark Utilities', 'dark-utilities', 'Expansive content mod which adds a little bit of everything.',
        'Expansive content mod which adds a little bit of everything.', 0, FALSE, TRUE, FROM_UNIXTIME(1456376130),
        FROM_UNIXTIME(1583382601), 1, 'minecraft-je',
        'mods'),
       ('Cursed', 'cursed', 'Adds new curses to Minecraft', 'Adds new curses to Minecraft', 0, 0, 1,
        FROM_UNIXTIME(1570773911),
        FROM_UNIXTIME(1583189079), 1, 'minecraft-je', 'mods'),
       ('Botany Pots', 'botany-pots', 'Adds pots that you can use to grow crops!',
        'Adds pots that you can use to grow crops!', 0, FALSE, TRUE, FROM_UNIXTIME(1575709035),
        FROM_UNIXTIME(1582103822), 1,
        'minecraft-je', 'mods'),
       ('Resource Hogs', 'resource-hogs', 'Adds pigs which can help players get resources.',
        'Adds pigs which can help players get resources.', 0, FALSE, TRUE, FROM_UNIXTIME(1537778190),
        FROM_UNIXTIME(1582159835), 1, 'minecraft-je', 'mods'),
       ('Hunting Dimension', 'hunting-dimension', 'Adds a dimension for hunting mobs.',
        'Adds a dimension for hunting mobs.', 0, FALSE, TRUE, FROM_UNIXTIME(1512817395), FROM_UNIXTIME(1579031323), 1,
        'minecraft-je', 'mods'),
       ('Thirsty Bottles', 'thirsty-bottles', 'A mod to make water bottles as thirsty as I am.',
        'A mod to make water bottles as thirsty as I am.', 0, FALSE, TRUE, FROM_UNIXTIME(1490299618),
        FROM_UNIXTIME(1582157328), 1, 'minecraft-je', 'mods'),
       ('Open Loader', 'open-loader', 'An open source resource and data loader for Minecraft.',
        'An open source resource and data loader for Minecraft.', 0, FALSE, TRUE, FROM_UNIXTIME(1576035011),
        FROM_UNIXTIME(1580592340), 1, 'minecraft-je',
        'mods'),
       ...
       ('Better Burning', 'better-burning', 'Improves the burning and fire mechanics of Minecraft.',
        'Improves the burning and fire mechanics of Minecraft.', 0, FALSE, TRUE, FROM_UNIXTIME(1575287161),
        FROM_UNIXTIME(1583098748), 1, 'minecraft-je',
        'mods'),
       ...
       ('Bad Mobs', 'bad-mobs', 'A mod to blacklist mobs from spawning.', 'A mod to blacklist mobs from spawning.', 0,
        FALSE, TRUE, FROM_UNIXTIME(1438051659), FROM_UNIXTIME(1583105091), 1, 'minecraft-je', 'mods'),
       ('Coloured Tooltips', 'coloured-tooltips', 'Allows the tooltip colors to be configured.',
        'Allows the tooltip colors to be configured.', 0, FALSE, TRUE, FROM_UNIXTIME(1516341777),
        FROM_UNIXTIME(1583108043),
        1, 'minecraft-je', 'mods'),
       ...
       ('Friendly Fire', 'friendly-fire', 'Modifies combat to prevent friendly fire to pets and other mobs.',
        'Modifies combat to prevent friendly fire to pets and other mobs.', 0, FALSE, TRUE, FROM_UNIXTIME(1481691209),
        FROM_UNIXTIME(1571187431), 1,
        'minecraft-je', 'mods'),
       ('Plummet', 'plummet', 'Allows you to prevent flying in some circumstances.',
        'Allows you to prevent flying in some circumstances.', 0, FALSE, TRUE, FROM_UNIXTIME(1573167604),
        FROM_UNIXTIME(1573168137), 1, 'minecraft-je', 'mods'),
       ('Amnesia Blocks', 'amnesia-blocks', 'Makes you randomly forget what a block is.',
        'Makes you randomly forget what a block is.', 0, FALSE, TRUE, FROM_UNIXTIME(1567061806),
        FROM_UNIXTIME(1568835541),
        1, 'minecraft-je', 'mods'),
       ('Never Enough Candy', 'never-enough-candy', 'Adds new candys for you to eat and collect.',
        'Adds new candys for you to eat and collect.', 0, FALSE, TRUE, FROM_UNIXTIME(1444452425),
        FROM_UNIXTIME(1576294472),
        1, 'minecraft-je', 'mods'),
       ('Pillagers', 'pillagers', 'Allows you to get villager loot by killing them.',
        'Allows you to get villager loot by killing them.', 0, FALSE, TRUE, FROM_UNIXTIME(1519350324),
        FROM_UNIXTIME(1571187718), 1, 'minecraft-je', 'mods'),
       ('RedShark', 'redshark', 'Allows the logging and tracking of network packets.',
        'Allows the logging and tracking of network packets.', 0, FALSE, TRUE, FROM_UNIXTIME(1523329118),
        FROM_UNIXTIME(1571187793), 1, 'minecraft-je', 'mods'),
       ('Item Stages', 'item-stages', 'Allows items to be restricted to a stage.',
        'Allows items to be restricted to a stage.', 0, FALSE, TRUE, FROM_UNIXTIME(1508536731),
        FROM_UNIXTIME(1571187786), 1,
        'minecraft-je', 'mods'),
       ('Get Ya\' Tanks Here', 'get-ya-tanks-here', 'Adds fluid tanks of various materials.',
        'Adds fluid tanks of various materials.', 0, FALSE, TRUE, FROM_UNIXTIME(1420275000), FROM_UNIXTIME(1571187826),
        1,
        'minecraft-je', 'mods'),
       ...
       ('Damage Control', 'damage-control', 'Allows for health and damage to be modified and rebalanced!',
        'Allows for health and damage to be modified and rebalanced!', 0, FALSE, TRUE, FROM_UNIXTIME(1487824492),
        FROM_UNIXTIME(1571187845), 1, 'minecraft-je',
        'mods'),
       ('Stuff A Sock In It', 'stuff-a-sock-in-it', 'Console filtering made easy!', 'Console filtering made easy!', 0,
        FALSE, TRUE, FROM_UNIXTIME(1488691129), FROM_UNIXTIME(1571187443), 1, 'minecraft-je', 'mods'),
       ('Caliper', 'caliper', 'A collection of tools for testing and developing mods and modpacks.',
        ...
        FROM_UNIXTIME(1493916343),
        FROM_UNIXTIME(1571190557), 1,
        'minecraft-je', 'mods'),
       ('Mob Banners', 'mob-banners', 'Adds decorative banners to commemorate your combat conquests.',
        'Adds decorative banners to commemorate your combat conquests.', 0, FALSE, TRUE, FROM_UNIXTIME(1538191953),
       ...
       ('Mod Debug World Type', 'mod-debug-world-type',
        ...
        'Allows the debug world type to show mods from a specific mod ID.', 0, FALSE, TRUE, FROM_UNIXTIME(1549092831),
       ...
       ('More Swords Mod', 'more-swords-mod', 'A simple mod that adds new swords and enchantments into the game.',
        'A simple mod that adds new swords and enchantments into the game.', 0, FALSE, TRUE, FROM_UNIXTIME(1371980040),
       ...
       ('Snail Mail', 'snail-mail', 'Adds new types of mail to the game.', 'Adds new types of mail to the game.', 0, 0,
        TRUE, FROM_UNIXTIME(1543395108), FROM_UNIXTIME(1543971012), 1, 'minecraft-je', 'mods'),
       ('Dark Utilities (Fabric)', 'dark-utilities-fabric', 'Adds random blocks that are sometimes useful.',
        'Adds random blocks that are sometimes useful.', 0, FALSE, TRUE, FROM_UNIXTIME(1545172644),
        FROM_UNIXTIME(1545176373), 1, 'minecraft-je', 'mods'),
       ('Informational Accessories', 'informational-accessories', 'Trinkets to help you better understand your world.',
        'Trinkets to help you better understand your world.', 0, FALSE, TRUE, FROM_UNIXTIME(1505453855),
        FROM_UNIXTIME(1543881759), 1, 'minecraft-je', 'mods'),
       ('JourneyMapStages', 'journeymapstages', 'Allows the JourneyMap mod to be staged with GameStages',
        'Allows the JourneyMap mod to be staged with GameStages', 0, FALSE, TRUE, FROM_UNIXTIME(1520540191),
        FROM_UNIXTIME(1552663257), 1, 'minecraft-je',
        'mods'),
       ('No AI Spawn Eggs', 'no-ai-spawn-eggs', 'Adds spawn eggs that spawn mobs with no AI.',
        'Adds spawn eggs that spawn mobs with no AI.', 0, FALSE, TRUE, FROM_UNIXTIME(1539034393),
        FROM_UNIXTIME(1543884635),
        1, 'minecraft-je', 'mods'),
       ('Tips', 'tips', 'This mod adds tips to loading menus. It also allows for modpacks and mods to...',
        ...
        FROM_UNIXTIME(1550911369), 1, 'minecraft-je', 'mods'),
       ('Enchanting Plus', 'enchanting-plus', 'Enchanting Plus', 'Enchanting Plus', 0, FALSE, TRUE,
        FROM_UNIXTIME(1371579488),
       ...
       ('Stage Tabels', 'stage-tabels', 'Allows game stages to be placed into weighted tables.',
        'Allows game stages to be placed into weighted tables.', 0, FALSE, TRUE, FROM_UNIXTIME(1547433081),
        FROM_UNIXTIME(1551404157), 1, 'minecraft-je',
        'mods'),
       ('Dark Elevators', 'dark-elevators', 'Adds a simple elevator block to the game.',
        'Adds a simple elevator block to the game.', 0, FALSE, TRUE, FROM_UNIXTIME(1546154771),
        FROM_UNIXTIME(1557210505), 1,
        'minecraft-je', 'mods'),
       ...
       ('Surge', 'surge', 'An open source performance enhancement mod.', 'An open source performance enhancement mod.',
        0, FALSE, TRUE, FROM_UNIXTIME(1472188259), FROM_UNIXTIME(1548629194), 1, 'minecraft-je', 'mods'),
       ('Kelpie', 'kelpie', 'Adds the kelpie from Scottish lore to MC.', 'Adds the kelpie from Scottish lore to MC.', 0,
        FALSE, TRUE, FROM_UNIXTIME(1506993271), FROM_UNIXTIME(1543883866), 1, 'minecraft-je', 'mods'),
       ('LootTableTweaker', 'loottabletweaker', 'LootTable support for CraftTweaker / MineTweaker3',
        'LootTable support for CraftTweaker / MineTweaker3', 0, FALSE, TRUE, FROM_UNIXTIME(1487716299),
        FROM_UNIXTIME(1543883916), 1, 'minecraft-je', 'mods'),
       ('Biome Specific Dungeons', 'biome-specific-dungeons',
        'Adds new dungeons which are based on the dungeons they spawn in.',
        'Adds new dungeons which are based on the dungeons they spawn in.', 0, FALSE, TRUE, FROM_UNIXTIME(1551847678),
        FROM_UNIXTIME(1552336182), 1,
        'minecraft-je', 'mods'),
       ('Simply Arrows', 'simply-arrows', 'Adds new arrows. What do you expect.',
        'Adds new arrows. What do you expect.', 0, FALSE, TRUE, FROM_UNIXTIME(1516939956), FROM_UNIXTIME(1538777131), 1,
        'minecraft-je', 'mods'),
       ('No Worldgen 5 You', 'no-worldgen-5-you', 'A simple mod that allows worldgen to be disabled.',
        'A simple mod that allows worldgen to be disabled.', 0, FALSE, TRUE, FROM_UNIXTIME(1502919021),
        FROM_UNIXTIME(1538497936), 1, 'minecraft-je', 'mods'),
       ...
       ('Ore Stages', 'ore-stages', 'Allows blocks like ores to be hidden and staged with Game Stages',
        'Allows blocks like ores to be hidden and staged with Game Stages', 0, FALSE, TRUE, FROM_UNIXTIME(1521172290),
       ...
       ('Dimension Stages', 'dimension-stages', 'Allows access to dimensions to be restricted based on stages.',
        'Allows access to dimensions to be restricted based on stages.', 0, FALSE, TRUE, FROM_UNIXTIME(1496909591),
        FROM_UNIXTIME(1543878872), 1,
        'minecraft-je', 'mods'),
       ('Spooky Jam 2018', 'spooky-jam-2018', 'The results of MMD\'s SpookyJam 2018!',
        'The results of MMD\'s SpookyJam 2018!', 0, FALSE, TRUE, FROM_UNIXTIME(1539638931), FROM_UNIXTIME(1540248595),
        1,
        'minecraft-je', 'mods'),
       ('Power Adapters', 'power-adapters', 'Adds new power adapter block to convert power.',
        'Adds new power adapter block to convert power.', 0, FALSE, TRUE, FROM_UNIXTIME(1518908037),
        FROM_UNIXTIME(1538512725), 1, 'minecraft-je', 'mods'),
       ('Cravings', 'cravings',
        ...
        FROM_UNIXTIME(1543877894), 1, 'minecraft-je', 'mods'),
       ('PigUtils', 'pigutils', 'A fork of iChunUtils without the EULA.', 'A fork of iChunUtils without the EULA.', 0,
        FALSE, TRUE, FROM_UNIXTIME(1529347386), FROM_UNIXTIME(1538801894), 1, 'minecraft-je', 'mods'),
       ('Waila Stages', 'waila-stages',
        ...
        FROM_UNIXTIME(1538512764), 1, 'minecraft-je', 'mods'),
       ('TESLA', 'tesla', 'A power API', 'A power API', 0, FALSE, TRUE, FROM_UNIXTIME(1462179367),
        FROM_UNIXTIME(1507310625),
        1, 'minecraft-je', 'mods'),
       ('Spooky Jam', 'spooky-jam', 'The results of MMD\'s SpookyJam 2017!', 'The results of MMD\'s SpookyJam 2017!', 0,
        FALSE, TRUE, FROM_UNIXTIME(1508151257), FROM_UNIXTIME(1508151574), 1, 'minecraft-je', 'mods'),
       ('Custom Tweaks', 'custom-tweaks', 'A series of tools to help customize modpacks',
        'A series of tools to help customize modpacks', 0, FALSE, TRUE, FROM_UNIXTIME(1471576171),
        FROM_UNIXTIME(1538449461),
        1, 'minecraft-je', 'mods'),
       ('Bookcase', 'bookcase', 'Additional utilities for making stardew mods and ensuring cross compatibility.',
        ...
        FROM_UNIXTIME(1543479262), 1, 'minecraft-je', 'mods'),
       ('Price Tooltips', 'price-tooltips', 'Adds item sell price info to tooltips',
        'Adds item sell price info to tooltips', 0, FALSE, TRUE, FROM_UNIXTIME(1532578908), FROM_UNIXTIME(1536387325),
        1,
        'minecraft-je', 'mods'),
       ('Natural Harvest', 'natural-harvest', 'Adds an abundance of natural resources to the world.',
        'Adds an abundance of natural resources to the world.', 0, FALSE, TRUE, FROM_UNIXTIME(1493406965),
        FROM_UNIXTIME(1495051439), 1, 'minecraft-je',
        'mods'),
       ('Waila Inhibitors', 'waila-inhibitors', 'This mod provides some balance to the Waila Mod.',
        'This mod provides some balance to the Waila Mod.', 0, FALSE, TRUE, FROM_UNIXTIME(1441076820),
        FROM_UNIXTIME(1445549924), 1, 'minecraft-je', 'mods'),
       ('Musica', 'musica',
       ...
       ('Cosmetic Armor', 'cosmetic-armor', 'Because it\'s important to be stylish',
        'Because it\'s important to be stylish', 0, FALSE, TRUE, FROM_UNIXTIME(1416978702), FROM_UNIXTIME(1417390296),
        1,
        'minecraft-je', 'mods'),
       ('StarStones', 'starstones', 'Meteors!', 'Meteors!', 0, FALSE, TRUE, FROM_UNIXTIME(1422387999),
        FROM_UNIXTIME(1434065271), 1, 'minecraft-je', 'mods'),
       ('Waila Events', 'waila-events', 'This mod adds several new events to the Waila mod.',
        'This mod adds several new events to the Waila mod.', 0, FALSE, TRUE, FROM_UNIXTIME(1439971529),
        FROM_UNIXTIME(1439989989), 1, 'minecraft-je', 'mods'),
       ('Get Ya\' Barrels Here', 'get-ya-barrels-here', 'Basic item storage and transport!',
        'Basic item storage and transport!', 0, FALSE, TRUE, FROM_UNIXTIME(1487979399), FROM_UNIXTIME(1491167140), 1,
        'minecraft-je', 'mods'),
       ('Game Stages', 'game-stages', 'An API for adding stages, for modpacks and other mods to use!',
        'An API for adding stages, for modpacks and other mods to use!', 0, FALSE, TRUE, FROM_UNIXTIME(1496012694),
       ...
       ('Mob Stages', 'mob-stages', 'This mod hooks in to the GameStage API, and allows mob spawning to be gated...',
        ...
        FROM_UNIXTIME(1543884038), 1, 'minecraft-je', 'mods'),
       ('Additional Banners', 'additional-banners', 'A whole new range of banner patterns, to enhance your world!',
        'A whole new range of banner patterns, to enhance your world!', 0, FALSE, TRUE, FROM_UNIXTIME(1430706855),
        FROM_UNIXTIME(1564433660), 1, 'minecraft-je',
        'mods'),
       ('Zalgo\'s Command', 'zalgo-s-command',
        ...
        FROM_UNIXTIME(1538512806), 1, 'minecraft-je', 'mods'),
       ...
       ('Colorful Mobs', 'colorful-mobs', 'Add diversity to your Minecraft world, by adding more colors!',
        'Add diversity to your Minecraft world, by adding more colors!', 0, FALSE, TRUE, FROM_UNIXTIME(1426129663),
       ...
       ('MCStats - Twitch Integration', 'mcstats-twitch-integration', 'Shows your statistics in a Twitch Extension!',
        'Shows your statistics in a Twitch Extension!', 0, FALSE, TRUE, FROM_UNIXTIME(1566876588),
        FROM_UNIXTIME(1568489346),
        2, 'minecraft-je', 'mods'),
       ...
       ('How Do I Do This Again?', 'how-do-i-do-this-again', 'Randomizes the main menu button locations.',
        'Randomizes the main menu button locations.', 0, FALSE, TRUE, FROM_UNIXTIME(1567006700),
        FROM_UNIXTIME(1567006920),
        2, 'minecraft-je', 'mods'),
       ('Ambient Environment', 'ambient-environment', 'Adds more ambiance to a Minecraft world',
        'Adds more ambiance to a Minecraft world', 0, FALSE, TRUE, FROM_UNIXTIME(1556150856), FROM_UNIXTIME(1583127730),
        2,
        'minecraft-je', 'mods'),
       ('CraftTweaker', 'crafttweaker', 'A continuation of MineTweaker originally by StanH',
        'A continuation of MineTweaker originally by StanH', 0, FALSE, TRUE, FROM_UNIXTIME(1451259974),
        FROM_UNIXTIME(1582845758), 2, 'minecraft-je', 'mods'),
       ...
       ('TipTheScales', 'tipthescales',
        ...
        FROM_UNIXTIME(1553126238), 2, 'minecraft-je', 'mods'),
       ('SewingKit', 'sewingkit', 'It\'s CraftTweaker for fabric!', 'It\'s CraftTweaker for fabric!', 0, 0, 1,
        FROM_UNIXTIME(1546907649),
        FROM_UNIXTIME(1559643560), 2, 'minecraft-je', 'mods'),
       ('Fabric Controlling', 'fabric-controlling', 'Adds a search bar to the Key-Bindings menu',
        'Adds a search bar to the Key-Bindings menu', 0, FALSE, TRUE, FROM_UNIXTIME(1544587271),
        FROM_UNIXTIME(1570556618),
        2, 'minecraft-je', 'mods'),
       ('Controlling', 'controlling', 'Adds a search bar to the Key-Bindings menu',
        'Adds a search bar to the Key-Bindings menu', 0, FALSE, TRUE, FROM_UNIXTIME(1472418436),
        FROM_UNIXTIME(1580168022),
        2, 'minecraft-je', 'mods'),
       ('Recipe Stages', 'recipe-stages', 'Allows for Crafting table recipes to be locked behind stages.',
        'Allows for Crafting table recipes to be locked behind stages.', 0, FALSE, TRUE, FROM_UNIXTIME(1508862748),
        FROM_UNIXTIME(1566472126), 2,
        'minecraft-je', 'mods'),
       ('Prestige', 'prestige', 'Allows progress that extends beyond a world.',
        'Allows progress that extends beyond a world.', 0, FALSE, TRUE, FROM_UNIXTIME(1521874163),
        FROM_UNIXTIME(1566510360),
        2, 'minecraft-je', 'mods'),
       ('ContentTweaker', 'contenttweaker', 'Allows you to add Items and Blocks', 'Allows you to add Items and Blocks',
        0, FALSE, TRUE, FROM_UNIXTIME(1445007558), FROM_UNIXTIME(1545878794), 2, 'minecraft-je', 'mods'),
       ('Hotbar Hotswap', 'hotbar-hotswap',
        ...
        FROM_UNIXTIME(1531857465), 2, 'minecraft-je', 'mods'),
       ('Fused', 'fused', 'Makes gunpowder placeable and trigger TNT blocks',
        'Makes gunpowder placeable and trigger TNT blocks', 0, FALSE, TRUE, FROM_UNIXTIME(1510515738),
        FROM_UNIXTIME(1510515855), 2, 'minecraft-je', 'mods'),
       ('World Book', 'world-book', 'Makes the world selection screen easier to use and find worlds',
        'Makes the world selection screen easier to use and find worlds', 0, FALSE, TRUE, FROM_UNIXTIME(1546753941),
        FROM_UNIXTIME(1546754056), 2,
        'minecraft-je', 'mods'),
       ('SAtIn', 'satin', 'Allows to custom Attack Indicator locations and scale',
        'Allows to custom Attack Indicator locations and scale', 0, FALSE, TRUE, FROM_UNIXTIME(1517360905),
        FROM_UNIXTIME(1517360982), 2, 'minecraft-je',
        'mods'),
       ('PrimalChests', 'primalchests', 'Adds intermediate chests that cannot hold as much as a normal chests',
        ...
        FROM_UNIXTIME(1503346503),
        FROM_UNIXTIME(1521493174), 2,
        'minecraft-je', 'mods'),
       ('WaitingTime', 'waitingtime', 'Adds a pong game to play while the pack is loading',
        'Adds a pong game to play while the pack is loading', 0, FALSE, TRUE, FROM_UNIXTIME(1514327681),
        FROM_UNIXTIME(1548714806), 2, 'minecraft-je', 'mods'),
       ...
       ('WAIM - What am I missing?', 'waim-what-am-i-missing',
        ...
        'A mod that makes the missing entries gui a bit easier to traverse!', 0, FALSE, TRUE, FROM_UNIXTIME(1517361561),
       ...
       ('Trash Trash', 'trash-trash',
        ...
        FROM_UNIXTIME(1531362312), 2, 'minecraft-je', 'mods'),
       ('Reputed', 'reputed', 'Allows for the tracking of weapon kills!', 'Allows for the tracking of weapon kills!', 0,
        FALSE, TRUE, FROM_UNIXTIME(1518270101), FROM_UNIXTIME(1520030404), 2, 'minecraft-je', 'mods'),
       ('You\'ve Got Mail - Twitch Integration', 'you-ve-got-mail-twitch-integration',
        ...
        0, FALSE, TRUE, FROM_UNIXTIME(1543579597), FROM_UNIXTIME(1549420940), 2, 'minecraft-je', 'mods'),
       ('ColCol', 'colcol', 'Addadd somsom colcol toto youyou liflif.', 'Addadd somsom colcol toto youyou liflif.', 0,
        FALSE, TRUE, FROM_UNIXTIME(1537698963), FROM_UNIXTIME(1537699040), 2, 'minecraft-je', 'mods'),
       ('DarkRooms', 'darkrooms', 'Brings back the old dark room mechanic for farming flowers easily!',
        'Brings back the old dark room mechanic for farming flowers easily!', 0, FALSE, TRUE, FROM_UNIXTIME(1548254796),
        FROM_UNIXTIME(1548256311), 2,
        'minecraft-je', 'mods'),
       ('Item Tooltips', 'item-tooltips', 'Displays the name of the currently held item.',
        'Displays the name of the currently held item.', 0, FALSE, TRUE, FROM_UNIXTIME(1531014424),
        FROM_UNIXTIME(1542486882), 2, 'minecraft-je', 'mods'),
       ('SlimyBoyos', 'slimyboyos', 'Makes slimes pickup items.', 'Makes slimes pickup items.', 0, 0, 1,
        FROM_UNIXTIME(1510761744),
        FROM_UNIXTIME(1510761773), 2, 'minecraft-je', 'mods'),
       ('Health Indicators', 'health-indicators', 'Plays a sound when you are low on health.',
        'Plays a sound when you are low on health.', 0, FALSE, TRUE, FROM_UNIXTIME(1442105852),
        FROM_UNIXTIME(1442106849), 2,
        'minecraft-je', 'mods'),
       ...
       ('Visualize', 'visualize', 'Visualize syncs video options between modpacks!',
        'Visualize syncs video options between modpacks!', 0, FALSE, TRUE, FROM_UNIXTIME(1497368958),
        FROM_UNIXTIME(1498839553), 2, 'minecraft-je', 'mods'),
       ...
       ('Tanks', 'tanks', 'Adds tanks that can hold 32 buckets of any liquid',
        'Adds tanks that can hold 32 buckets of any liquid', 0, FALSE, TRUE, FROM_UNIXTIME(1451582922),
        FROM_UNIXTIME(1460640474), 2, 'minecraft-je', 'mods'),
       ('{ JSONAbles }', 'jsonables', 'Add Tinker\'s Construct tools via json!',
        'Add Tinker\'s Construct tools via json!', 0, FALSE, TRUE, FROM_UNIXTIME(1425900845), FROM_UNIXTIME(1456684790),
        2,
        'minecraft-je', 'mods'),
       ...
       ('Harvest Reader', 'harvest-reader', 'Adds an item to display information about Harvest Festival crops!',
        'Adds an item to display information about Harvest Festival crops!', 0, FALSE, TRUE, FROM_UNIXTIME(1497213017),
       ...
       ('Mystical Trinkets', 'mystical-trinkets', 'Mystical Trinkets', 'Mystical Trinkets', 0, 0, 1,
        ...
        FROM_UNIXTIME(1404340023), 2, 'minecraft-je', 'mods'),
       ('Machines and Stuff', 'machines-and-stuff', 'Adds useful machines and generators!',
        'Adds useful machines and generators!', 0, FALSE, TRUE, FROM_UNIXTIME(1494282563), FROM_UNIXTIME(1495575112), 2,
        'minecraft-je', 'mods'),
       ...
       ('Fluxed-Crystals 2', 'fluxed-crystals-2', 'Generate resources and materials at the expense of RF!',
        'Generate resources and materials at the expense of RF!', 0, FALSE, TRUE, FROM_UNIXTIME(1435188634),
        FROM_UNIXTIME(1439913880), 2, 'minecraft-je',
        'mods'),
       ('Fluxed-Core', 'fluxed-core', 'A mod that contains helper functions for all of my mods',
        'A mod that contains helper functions for all of my mods', 0, FALSE, TRUE, FROM_UNIXTIME(1444912766),
        FROM_UNIXTIME(1460629442), 2, 'minecraft-je',
        'mods'),
       ('JAIM - Just Another Information Mod', 'jaim-just-another-information-mod',
        ...
        'Overhauls the select world screen and displays extra information!', 0, FALSE, TRUE, FROM_UNIXTIME(1481492093),
