...
public class FileDatabase implements FileDAO {
    ...
    public List<ProjectFileRecord> findAllByGameSlugAndProjectTypeAndProjectSlug (String gameSlug, String projectTypeSlug, String projectSlug, long page, int limit, ProjectFileFilter filter) {
        ...
        try (PreparedStatement stmt = filter.getFilteredQuery(FIND_ALL_BY_GAMESLUG_AND_PROJECTYPESLUG_AND_PROJECTSLUG)) {
    ...
    public List<ProjectFileRecord> findAllByGameSlugAndProjectTypeAndProjectSlugAuthorized (String gameSlug, String projectTypeSlug, String projectSlug, long page, int limit, ProjectFileFilter filter) {
        ...
        List<ProjectFileRecord> projects = new ArrayList<>();
        try (PreparedStatement stmt = filter.getFilteredQuery(FIND_ALL_BY_GAMESLUG_AND_PROJECTYPESLUG_AND_PROJECTSLUG_AUTHORIZED)) {
            stmt.setString(1, gameSlug);
            stmt.setString(2, projectTypeSlug);
            stmt.setString(3, projectSlug);
            stmt.setLong(4, (page - 1) * limit);
